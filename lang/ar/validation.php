...
return [
    ...
    */
    ...
    'duplicate_values' => 'يجب أن لا تتكرر قيمة حقل :attribute',
    'arrays_equals_length' => 'يجب ان يكون حقل :attribute مساوياً لحقل :other',
    ...
    */
    ...
    'attributes' => [
        ...
        'links' => 'الروابط',
        'links.*.type' => 'نوع الرابط',
        'links.*.url' => 'عنوان الرابط',
        'image_path' => 'الصورة',
        'price' => 'السعر',
        'description' => 'الوصف',
        'quantity' => 'الكمية',
