"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Dashboard_BlogsManagement_ArticleForm_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Form/TextArea.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Form/TextArea.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_Form_InputFile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../components/Form/InputFile */ "./resources/js/components/Form/InputFile.vue");
/* harmony import */ var _components_Form_TextSelect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/Form/TextSelect */ "./resources/js/components/Form/TextSelect.vue");
...
/* harmony import */ var _components_SuccessAlert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../components/SuccessAlert */ "./resources/js/components/SuccessAlert.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    SuccessAlert: _components_SuccessAlert__WEBPACK_IMPORTED_MODULE_5__["default"],
    InputFile: _components_Form_InputFile__WEBPACK_IMPORTED_MODULE_2__["default"],
    Input: _components_Form_TextInput__WEBPACK_IMPORTED_MODULE_1__["default"],
    TextSelect: _components_Form_TextSelect__WEBPACK_IMPORTED_MODULE_3__["default"],
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapState)({
    TrainingProgram: function TrainingProgram(state) {
      return state.admin.TrainingPrograms.trainingPrograms.data;
    },
    TargetsList: function TargetsList(state) {
      return state.admin.Targets.targets.data;
    },
    DifficultyRates: function DifficultyRates(state) {
      return state.admin.DifficultyLevel.difficulties.data;
    },
    Genders: function Genders(state) {
      return state.admin.Genders.genders.data;
    },
    errors: function errors(state) {
      return state.admin.TrainingPrograms.trainingProgram.errors;
    }
  })), {}, {
    gendersCustom: function gendersCustom() {
      var gendersArray = [];
      var genders = this.Genders;
      for (var i = 0; i < genders.length; i++) {
        if (genders[i].name === 'male') {
          gendersArray.push({
            id: genders[i].id,
            name: 'ذكر'
          });
        } else if (genders[i].name === 'female') {
          gendersArray.push({
            id: genders[i].id,
            name: 'انثى'
          });
  ...
  created: function created() {
    var _this = this;
    this.cleanErrors();
    _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/fetchTargetsList', {
      limit: 10
    });
    _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/fetchDifficultiesList', {
      limit: 10
    });
    _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/fetchGendersList', {
      limit: 10
    });
    this.form.id = this.$route.params.id !== undefined ? this.$route.params.id : '';
    if (this.form.id) {
      var training_program = this.form.id;
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/viewSpecificTrainingProgram', training_program).then(function (response) {
        _this.form.id = _this.TrainingProgram.id;
        _this.form.gender_id = _this.TrainingProgram.gender_id;
        _this.form.name = _this.TrainingProgram.name;
        _this.form.description = _this.TrainingProgram.description;
        _this.form.target_id = _this.TrainingProgram.target_id;
        _this.form.number_of_days = _this.TrainingProgram.number_of_days;
        _this.form.difficulty_id = _this.TrainingProgram.difficulty_id;
        _this.form.visual_media_type = _this.TrainingProgram.visual_media_type;
        _this.form.media = _this.TrainingProgram.media;
        _this.form.status = _this.TrainingProgram.status;
      });
    }
  },
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapMutations)({
    cleanErrors: "admin/cleanTrainingProgramsErrors"
  })), {}, {
    HandleInput: function HandleInput(key, value) {
      this.form[key] = value;

      //checking the type of uploaded file
      if (this.imageFormats.includes(value.type)) {
        this.form.visual_media_type = "image";
      } else if (this.videoFormats.includes(value.type)) {
        this.form.visual_media_type = "video";
      }
    },
    onSubmit: function onSubmit() {
      ...
      for (var key in this.form) {
        if (key == 'status') formData.append(key, this.form[key] ? 1 : 0);else formData.append(key, this.form[key]);
      }
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/createNewTrainingProgram', formData).then(function (response) {
        _this2.cleanErrors();
        _this2.Alert.message = 'تمّت اضافة برنامج تدريبي بنجاح';
    ...
    onUpdate: function onUpdate() {
      ...
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/updateTrainingProgram', formData).then(function (response) {
        _this3.cleanErrors();
        _this3.Alert.message = 'تمّ تعديل البرنامج التّدريبي بنجاح';
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Form/TextArea.vue?vue&type=template&id=7249618a&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Form/TextArea.vue?vue&type=template&id=7249618a&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _withScopeId = function _withScopeId(n) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.pushScopeId)("data-v-7249618a"), n = n(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.popScopeId)(), n;
};
var _hoisted_1 = {
  "class": "form__group field"
};
var _hoisted_2 = ["value", "placeholder", "id"];
var _hoisted_3 = ["for"];
var _hoisted_4 = {
  key: 0,
  "class": "invalid-feedback"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)($props.class_bs)
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("textarea", {
    value: $props.MyValue,
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([{
      'invalid-border': $props.errors[$props.Mykey]
    }, "form__field"]),
    ...
    "for": $props.id,
    "class": "form__label"
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.title), 9 /* TEXT, PROPS */, _hoisted_3), $props.errors[$props.Mykey] ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.errors[$props.Mykey][0]), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 2 /* CLASS */);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name == null ? item.user_name : item.name), 9 /* TEXT, PROPS */, _hoisted_2);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=template&id=fe507aea&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=template&id=fe507aea&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _withScopeId = function _withScopeId(n) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.pushScopeId)("data-v-fe507aea"), n = n(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.popScopeId)(), n;
};
var _hoisted_1 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SuccessAlert, {
    ...
    back: this.goBack
  }, null, 8 /* PROPS */, ["title", "message", "back"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h4", _hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.IsNew ? 'اضافة برنامج تدريبي جديد' : 'تعديل برنامج تدريبي'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.IsNew ? 'سيتم اضافة برنامج تدريبي للنظام ' : 'سيتم التعديل على برنامج تدريبي في النظام'), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    ...
    Mykey: "media",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_TextSelect, {
    title: "الجنس المُستهدف",
    id: "gender_id",
    Items: $options.gendersCustom,
    onSelect: _cache[2] || (_cache[2] = function ($event) {
      return $options.HandleInput('gender_id', $event);
    }),
    Mykey: "gender_id",
    MyValue: $data.form.gender_id,
    errors: _ctx.errors
    ...
    id: "target_id",
    Items: _ctx.TargetsList,
    onSelect: _cache[3] || (_cache[3] = function ($event) {
      return $options.HandleInput('target_id', $event);
    }),
    Mykey: "target_id",
    MyValue: $data.form.target_id,
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["Items", "MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_TextSelect, {
    title: "المستوى",
    id: "difficulty_id",
    Items: _ctx.DifficultyRates,
    onSelect: _cache[4] || (_cache[4] = function ($event) {
      return $options.HandleInput('difficulty_id', $event);
    }),
    Mykey: "difficulty_id",
    MyValue: $data.form.difficulty_id,
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["Items", "MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    title: "عدد الأيّام",
    id: "number_of_days",
    min: 1,
    max: 7,
    onInput: _cache[5] || (_cache[5] = function ($event) {
      return $options.HandleInput('number_of_days', $event);
    }),
    MyType: _ctx.number,
    MyValue: $data.form.number_of_days,
    Mykey: "number_of_days",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyType", "MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <TextArea title=\"الوصف\" :MyValue=\"form.description\" id=\"description\" @Input=\"HandleInput('description',$event)\" Mykey=\"description\" :errors= 'errors'/> ")]), $options.IsNew ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 0,
    type: "button",
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".invalid-feedback[data-v-7249618a] {\n  color: #e91e1e;\n  display: block;\n}\n.invalid-border[data-v-7249618a] {\n  border-bottom: 1px solid #e91e1e !important;\n}\n.form__group[data-v-7249618a] {\n  position: relative;\n  padding: 15px 0 0;\n  margin-top: 10px;\n  text-align: start;\n}\n.form__field[data-v-7249618a] {\n  width: 100%;\n  border: 0;\n  border-bottom: 1px solid #d2d2d2;\n  outline: 0;\n  font-size: 0.875rem;\n  color: #251c1c;\n  padding: 7px 0;\n  background: transparent;\n  transition: border-color 0.2s;\n}\n.form__field[data-v-7249618a]::-moz-placeholder {\n  color: transparent;\n}\n.form__field[data-v-7249618a]::placeholder {\n  color: transparent;\n}\n.form__field:-moz-placeholder-shown ~ .form__label[data-v-7249618a] {\n  font-size: 0.875rem;\n  cursor: text;\n  top: 20px;\n}\n.form__field:placeholder-shown ~ .form__label[data-v-7249618a] {\n  font-size: 0.875rem;\n  cursor: text;\n  top: 20px;\n}\n.form__label[data-v-7249618a] {\n  position: absolute;\n  top: 0;\n  display: block;\n  transition: 0.2s;\n  font-size: 0.875rem;\n  color: #495057;\n}\n.form__field[data-v-7249618a]:focus {\n  padding-bottom: 6px;\n  font-weight: 700;\n  border-width: 2px;\n  -o-border-image: linear-gradient(to right, #37517e, #37517e);\n     border-image: linear-gradient(to right, #37517e, #37517e);\n  border-image-slice: 1;\n}\n.form__field:focus ~ .form__label[data-v-7249618a] {\n  position: absolute;\n  top: 0;\n  display: block;\n  transition: 0.2s;\n  font-size: 1rem;\n  color: #37517e;\n  font-weight: 700;\n}\n\n/* reset input */\n.form__field[data-v-7249618a]:required, .form__field[data-v-7249618a]:invalid {\n  box-shadow: none;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=style&index=0&id=fe507aea&lang=scss&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/BlogsManagement/ArticleForm.vue?vue&type=style&index=0&id=fe507aea&lang=scss&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".row-custom[data-v-fe507aea] {\n  justify-content: center;\n}\n.card .card-header[data-v-fe507aea] {\n  background: #37517e;\n  color: white;\n}\n.card-header[data-v-fe507aea] {\n  text-align: right;\n}\n.invalid-feedback[data-v-fe507aea] {\n  color: #e91e1e;\n  display: block;\n}\n.invalid-border[data-v-fe507aea] {\n  border-bottom: 1px solid #e91e1e !important;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_TextArea_vue_vue_type_style_index_0_id_7249618a_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./TextArea.vue?vue&type=style&index=0&id=7249618a&lang=scss&scoped=true */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Form/TextArea.vue?vue&type=style&index=0&id=7249618a&lang=scss&scoped=true");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_