"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Dashboard_ProjectsManagement_ProjectForm_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapState)({
    Project: function Project(state) {
      return state.admin.Projects.projects.data;
    },
    errors: function errors(state) {
      return state.admin.Projects.project.errors;
    }
  })), {}, {
  ...
  created: function created() {
    ...
    if (this.form.uuid) {
      var project_uuid = this.form.uuid;
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].commit('admin/PleaseStartLoading');
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/viewSpecificProject', project_uuid).then(function (response) {
        _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].commit('admin/PleaseStopLoading');
        _this.form.uuid = _this.Project.uuid;
        _this.Project.media.forEach(function (value) {
          console.log(value);
          _this.form.media.push({
            file: value.url,
            previewUrl: value.url
          });
        });
        _this.form.title_ar = _this.Project.title_ar;
        _this.form.title_en = _this.Project.title_en;
        _this.form.description_ar = _this.Project.description_ar;
        _this.form.description_en = _this.Project.description_en;
        if (_this.Project.links[0]) {
          _this.form.url_0 = _this.Project.links[0].url;
        }
        if (_this.Project.links[1]) {
          _this.form.url_1 = _this.Project.links[1].url;
        }
        if (_this.Project.links[2]) {
          _this.form.url_2 = _this.Project.links[2].url;
        }
      });
    }
  },
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapMutations)({
    cleanErrors: "admin/cleanProjectErrors"
  })), {}, {
    ...
    onSubmit: function onSubmit() {
      ...
      for (var i = 0; i < this.form.media.length; i++) {
        formData.append("media[".concat(i, "]"), this.form.media[i].file);
      }
      formData.append("title[ar]", this.form.title_ar);
      formData.append("title[en]", this.form.title_en);
      formData.append("description[ar]", this.form.description_ar);
      formData.append("description[en]", this.form.description_en);
      formData.append("links[0][type]", this.form.type_0);
      formData.append("links[0][url]", this.form.url_0);
      formData.append("links[1][type]", this.form.type_1);
      formData.append("links[1][url]", this.form.url_1);
      formData.append("links[2][type]", this.form.type_2);
      formData.append("links[2][url]", this.form.url_2);
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/createNewProject', formData).then(function (response) {
        _this2.cleanErrors();
        _this2.Alert.message = 'تمّت اضافة مشروع جديد';
    ...
    onUpdate: function onUpdate() {
      ...
      _store_index__WEBPACK_IMPORTED_MODULE_0__["default"].dispatch('admin/updateProject', formData).then(function (response) {
        _this3.cleanErrors();
        _this3.Alert.message = 'تمّ تعديل بيانات المشروع بنجاح';
    ...
    showImage: function showImage(index) {
      this.selectedImage = this.form.media[index];
      this.showModal = true;
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _withScopeId = function _withScopeId(n) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.pushScopeId)("data-v-f44129a2"), n = n(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.popScopeId)(), n;
};
var _hoisted_1 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SuccessAlert, {
    ...
    back: this.goBack
  }, null, 8 /* PROPS */, ["title", "message", "back"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h4", _hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.IsNew ? 'اضافة مشروع جديد' : 'تعديل بيانات مشروع'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.IsNew ? 'سيتم اضافة مشروع جديد للنظام ' : 'سيتم التعديل على بيانات مشروع في النظام'), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [_hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  }, null, 32 /* HYDRATE_EVENTS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.form.media, function (image, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: index,
      "class": "image-item"
    ...
    }, "X", 8 /* PROPS */, _hoisted_14)]);
  }), 128 /* KEYED_FRAGMENT */))]), $data.showModal ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    "class": "myModal",
    ...
    src: $data.selectedImage.previewUrl,
    alt: "Preview",
    "class": "modal-image"
  }, null, 8 /* PROPS */, _hoisted_16)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    MyValue: $data.form.title_ar,
    id: "title_ar",
    title: "اسم المشروع بالعربي",
    onMyInput: _cache[3] || (_cache[3] = function ($event) {
      return $options.HandleInput('title_ar', $event);
    }),
    Mykey: "title.ar",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    MyValue: $data.form.title_en,
    id: "title_en",
    title: "اسم المشروع بالانحليزي",
    onMyInput: _cache[4] || (_cache[4] = function ($event) {
      return $options.HandleInput('title_en', $event);
    }),
    Mykey: "title.en",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    ...
    id: "description_en",
    title: "نبذة عن المشروع بالانحليزية",
    onMyInput: _cache[6] || (_cache[6] = function ($event) {
      return $options.HandleInput('description_en', $event);
    }),
    Mykey: "description.en",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <InputFile :MyValue=\"form.media\" title=\"الصورة\" id=\"media\" Mykey=\"media\" @Input=\"HandleInput('media',$event)\" :errors= 'errors'/> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    MyValue: $data.form.url_0,
    id: "url_0",
    title: "رابط الموقع الالكتروني",
    onMyInput: _cache[7] || (_cache[7] = function ($event) {
      return $options.HandleInput('url_0', $event);
    }),
    Mykey: "links.0.url",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    MyValue: $data.form.url_1,
    id: "url_1",
    title: "رابط Android",
    onMyInput: _cache[8] || (_cache[8] = function ($event) {
      return $options.HandleInput('url_1', $event);
    }),
    Mykey: "links.1.url",
    errors: _ctx.errors
  }, null, 8 /* PROPS */, ["MyValue", "errors"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Input, {
    MyValue: $data.form.url_2,
    id: "url_2",
    title: "رابط IOS",
    onMyInput: _cache[9] || (_cache[9] = function ($event) {
      return $options.HandleInput('url_2', $event);
    }),
    Mykey: "links.2.url",
    errors: _ctx.errors
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".row-custom[data-v-f44129a2] {\n  justify-content: center;\n}\n.card .card-header[data-v-f44129a2] {\n  background: #37517e;\n  color: white;\n}\n.card-header[data-v-f44129a2] {\n  text-align: right;\n}\n.invalid-feedback[data-v-f44129a2] {\n  color: #e91e1e;\n  display: block;\n}\n.invalid-border[data-v-f44129a2] {\n  border-bottom: 1px solid #e91e1e !important;\n}\n.MultiFileInput[data-v-f44129a2] {\n  display: none;\n}\n\n/* Style for the file input label */\nlabel[data-v-f44129a2] {\n  padding: 10px 20px;\n  background: linear-gradient(60deg, #343a40, #37517e);\n  color: #ffffff;\n  font-size: 16px;\n  font-weight: bold;\n  cursor: pointer;\n  border-radius: 4px;\n  transition: background-color 0.3s ease;\n}\nlabel[data-v-f44129a2]:hover {\n  background-color: #242122;\n}\n.image-container[data-v-f44129a2] {\n  display: flex;\n  flex-wrap: wrap;\n  margin-top: 20px;\n}\n.image-item[data-v-f44129a2] {\n  position: relative;\n  margin-right: 10px;\n  margin-bottom: 10px;\n}\n.profile-pic[data-v-f44129a2] {\n  width: 80px;\n  height: 80px;\n  -o-object-fit: cover;\n     object-fit: cover;\n  border-radius: 50%;\n  cursor: pointer;\n}\n.remove-button[data-v-f44129a2] {\n  position: absolute;\n  top: 5px;\n  right: 5px;\n  padding: 5px;\n  background-color: #f44336;\n  color: white;\n  border: none;\n  border-radius: 50%;\n  cursor: pointer;\n  font-weight: bold;\n}\n.remove-button[data-v-f44129a2]:hover {\n  background-color: #d32f2f;\n}\n\n/* Modal styles */\n.myModal[data-v-f44129a2] {\n  display: block;\n  position: fixed;\n  z-index: 100000000000;\n  padding-top: 50px;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.8);\n}\n.modal-content[data-v-f44129a2] {\n  margin: auto;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 80%;\n  max-width: 800px;\n  height: 80%;\n}\n.modal-image[data-v-f44129a2] {\n  width: 100%;\n  height: auto;\n  -o-object-fit: contain;\n     object-fit: contain;\n}\n.close[data-v-f44129a2] {\n  position: absolute;\n  top: 20px;\n  right: 30px;\n  font-size: 35px;\n  font-weight: bold;\n  color: #37517e;\n  cursor: pointer;\n}\n.close[data-v-f44129a2]:hover,\n.close[data-v-f44129a2]:focus {\n  color: #8f1a41;\n  text-decoration: none;\n  cursor: pointer;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_style_index_0_id_f44129a2_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_style_index_0_id_f44129a2_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue":
/*!*************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ProjectForm_vue_vue_type_template_id_f44129a2_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true */ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true");
/* harmony import */ var _ProjectForm_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectForm.vue?vue&type=script&lang=js */ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js");
/* harmony import */ var _ProjectForm_vue_vue_type_style_index_0_id_f44129a2_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true */ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true");
/* harmony import */ var _node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ProjectForm_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_ProjectForm_vue_vue_type_template_id_f44129a2_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render],['__scopeId',"data-v-f44129a2"],['__file',"resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js":
/*!*************************************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./ProjectForm.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=script&lang=js");
...
/***/ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true":
/*!*******************************************************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true ***!
  \*******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_template_id_f44129a2_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_template_id_f44129a2_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=template&id=f44129a2&scoped=true");
...
/***/ "./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true":
/*!**********************************************************************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true ***!
  \**********************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_ProjectForm_vue_vue_type_style_index_0_id_f44129a2_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/pages/Dashboard/ProjectsManagement/ProjectForm.vue?vue&type=style&index=0&id=f44129a2&lang=scss&scoped=true");
